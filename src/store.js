...
const productSlice = createSlice({
    ...
    initialState: {
        veg: [
            ...
            { name: 'potato', price: 250.07, image: "public/potato.jpg" },
            { name: 'carrot', price: 300.05, image: "public/carrot.jpg" },
            { name: 'chilli', price: 10.05, image: "public/chilli.jpg" },
            { name: 'ladys finger', price: 60.05, image: "public/lady.png" },
            { name: 'cabbage', price: 80.05, image: "public/cab.png" },
            { name: 'cauliflower', price: 100.05, image: "public/cali.png" },
            { name: 'beans', price: 40.05, image: "public/beans.png" },
            

        ],
        nonveg: [
            { name: 'chicken', price: 300.05, image: "public/chick.jpg" },
            { name: 'mutton', price: 850.07, image: "public/mutton.jpg" },
            { name: 'fish', price: 1000.05, image: "public/fish.jpg" },
            { name: 'prawns', price: 900.05, image: "public/prw.png" },
            { name: 'crabe', price: 800.05, image: "public/crab.png" },
            { name: 'lobster', price: 950.05, image: "public/lob.png" },
            { name: 'apollo fish', price: 1150.05, image: "public/apoll.jpg" },
            { name: 'leg pices', price: 500.05, image: "public/leg.jpg" },
